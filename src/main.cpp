...
int main(){
	...
	// The following is our menu. There is a sub menu for data analytics; the idea is that
	// this is an easy platform to add additional analytics that could be of use to local
	// law enforcement.
